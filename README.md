...
- [_] **10/11/22** [LINK](https://www.usenix.org/system/files/sec22-vadayath.pdf) Vadayath, Jayakrishna, et al. "Arbiter: Bridging the Static and Dynamic Divide in Vulnerability Discovery on Binary Programs." 31st USENIX Security Symposium (USENIX Security 22). 2022.

- [_] **10/11/22** [LINK](https://www.usenix.org/system/files/sec20-brown.pdf) Brown, Fraser, Deian Stefan, and Dawson Engler. "Sys: A {Static/Symbolic} Tool for Finding Good Bugs in Good (Browser) Code." 29th USENIX Security Symposium (USENIX Security 20). 2020.
